...
public final class goodsRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<title>其他管理--登入商品</title>\r\n");
      ...
      out.write("      <div class=\"layui-input-inline\">\r\n");
      out.write("        <input type=\"text\" name=\"promitcode\" id=\"promitcode\"   autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    \r\n");
      out.write("     <div class=\"layui-inline\">\r\n");
      ...
      out.write("            \tpromitcode: $(\"#promitcode\").val(),  //搜索的关键字\r\n");
      out.write("                size: $(\"#size\").val(),  //搜索的关键字\r\n");
      ...
      out.write("        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/goods/loadAllGoods.action',\r\n");
      ...
      out.write("            {field: 'id', title: '商品ID',align:\"center\"},\r\n");
      out.write("            {field: 'goodsname', title: '商品名称',width:150,align:\"center\"},\r\n");
      out.write("            {field: 'produceplace', title: '产地', align:'center'},\r\n");
      out.write("            {field: 'size', title: '规格', align:'center'},\r\n");
      out.write("            {field: 'goodspackage', title: '包装', width:150,align:'center'},\r\n");
      out.write("            {field: 'productcode', title: '生产批号',width:150,  align:'center'},\r\n");
      out.write("            {field: 'promitcode', title: '批准文号',width:150,  align:'center'},\r\n");
      out.write("            {field: 'description', title: '描述',width:150,  align:'center'},\r\n");
      out.write("            {field: 'price', title: '销售价格', width:180,  align:'center'},\r\n");
      out.write("            {field: 'providerid', title: '供应商编号', width:180, align:'center'},\r\n");
      out.write("            {field: 'number', title: '库存数量',  align:'center'},\r\n");
      out.write("            {field: 'dangernum', title: '预警数量',  align:'center'},\r\n");
      out.write("            {field: 'goodsimg', title: '商品图片',  align:'center',templet:function(data){\r\n");
      out.write("            \treturn \"<img  src=\"+data.goodsimg+\">\"\r\n");
      out.write("            }},\r\n");
      ...
      out.write("             }},\r\n");
      out.write("            {title: '操作', width:180, templet:'#goodsListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("        ]]\r\n");
      out.write("    });\r\n");
      ...
      out.write("        var checkStatus = table.checkStatus('goodsListTable'),\r\n");
      out.write("            data = checkStatus.data,\r\n");
      out.write("            url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/goods/delGoodses.action?1=1\";\r\n");
      ...
      out.write("    \t\t  $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/goods/delGoods.action?id=\"+id,function(result){\r\n");
      out.write("    \t          \tlayer.msg(result.msg);\r\n");
      out.write("\t                layer.close(index);\r\n");
      out.write("\t                tableIns.reload();\r\n");
      out.write("    \t          });\r\n");
