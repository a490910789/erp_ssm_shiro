		...
		<input type="hidden" name="id" value="${permission.id }">
			<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<div id="pid"  name="pid" value="${permission.pid }" class="layui-form-select select-tree"></div>
					</div>
			        <label class="layui-form-label">排序码</label>
			         <div class="layui-input-inline">
						<input type="number" name="ordernum" value="${permission.ordernum }" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="name" value="${permission.name }" autocomplete="off"
						class="layui-input">
				</div>
				<label class="layui-form-label">权限编码</label>
				<div class="layui-input-inline">
					<input type="text" name="name" value="${permission.percode }" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="radio" name="available" value="1" title="是" ${permission.available eq 1?'checked':'' }>
						<input type="radio" name="available" value="0" title="否" ${permission.available eq 0?'checked':'' }>
					</div>
				</div>
			</div>
			<div class="layui-form-item">
...
<script type="text/javascript">
	 layui.use(['form','jquery','layer'], function () {
		 ...
		 form.on("submit(formSubmit)",function(data){
	       ...
	       $.post("${ctx}/permission/updatePermission.action?"+params,function(result){
