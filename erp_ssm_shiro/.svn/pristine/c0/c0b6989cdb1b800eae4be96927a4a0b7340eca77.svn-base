...
public class RandomUtils {
	...
	private static SimpleDateFormat sdf3=new SimpleDateFormat("yyyy_MMdd_HHmmss_SSS");
	private static Random random=new Random();
	/**
	 * 使用时间+四位随机数
	 * 
	 * sdfasfdsafdsafdsa.gif
	 */
	...
	public static String createRandomStrUseTime(String prefix){
		return prefix+"_"+sdf3.format(new Date())+(random.nextInt(90000)+10000);
	}
